 ...
 * - ACTIVATING: Transition state during ACTIVATE command (not used in this implementation)
 * - ACTIVE: Bank open with specific row active, ready for RD/WR
 * - PRECHARGING: Transition state during PRECHARGE command (not used in this implementation)
 */
